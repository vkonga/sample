           ...
           <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center space-y-4 mb-12">
              ...
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                Here is a sample storybook generated by SalistleAI, from a simple idea to a complete, illustrated book.
              </p>
            </div>

            <div className="space-y-8 md:space-y-12">
              {storyPages.map((page, index) => (
                <Card key={index} className="overflow-hidden shadow-lg w-full max-w-3xl mx-auto">
                  <CardContent className="p-0">
                    {page.image && (
                     ...
                     <div className="p-6 md:p-8 space-y-4">
                      {page.type === "cover" ? (
                        <h3 className="text-2xl md:text-3xl font-bold font-headline text-center">{page.text}</h3>
                      ) : (
                        <p className="text-base md:text-lg text-muted-foreground leading-relaxed">{page.text}</p>
                      )}
                      {page.type === "end" && (
                         <p className="text-xl md:text-2xl font-bold font-headline text-center mt-6">{page.endText}</p>
                      )}
                    </div>
                  </CardContent>
                </Card>
